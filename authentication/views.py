...
from authentication.permissions import (
    IsClientAdmin, IsProfileOwner, IsOwnerOrAdmin)
...
class RegistrationAPIView(generics.GenericAPIView):
    ...
    def post(self, request):
        ...
        payload = {
            "subject": "Acres Account Verification | Welcome Aboard",
        ...
        response = {
            "data": {
                "user": dict(user_data),
                "message": "Awesome, Your account has been created successfully. "
                           "We have sent you and email with next steps. "
                           "Please check your email to activate your account. "
                           "After that, let's do what we do best.",
                "status": "success"
            }
        }
    ...
    def get(self, request):
        ...
        try:
            ...
            return HttpResponseRedirect(
                domain + '?verified_status=invalid_link')
        ...
        if user.is_verified:
            return self.sendResponse("You have already activated this account")
...
class ClientCreateView(generics.GenericAPIView, BaseUtils):
    ...
    def get(self, request):
        ...
        if len(serializer.data) == 0:
            response = {
                "data": {
                    "message": "You don't have any componaies registered yet"
                }
            }
            ...
            response = {
                "data": {
                    ...
                    "message": "You have activated any company yet",
                }
            }
    ...
    def post(self, request):
        ...
        response = {
            ...
            "message": "Awesome, Your request to create a company has been "
                       "received. Let's review and we will get back to you."
        }
    ...
    def delete(self, request):
        ...
        company = self.get_queryset()
        if not company:
            return Response({"errors": "This company does not exist in our database"},
...
class RetrieveUpdateDeleteClientView(APIView):
    ...
    def get_object(self, request, company_id):
        ...
        try:
            ...
            raise NotFound(detail={"errors": "This company does not exist in our database"},
    ...
    def patch(self, request, **kwargs):
        """
        Handles updates to a user's company details once created.
        :param request:
        :return: company Details
        """
        data = request.data
        ...
        response = {
            "client_company": serializer.data,
            "message": "Updates to your company details were successful."
        }
...
class AddReasonView(View):
    ...
    def post(self, request):
        ...
        message = ''
        if status == "revoked":
            message = 'Hey there,\n\nyour approval to Acres was revoked'\
                ',with the following reason \n\n{}'                                                                                     .format(
                    notes)
        elif status == 'rejected':
            message = 'Hey there,\n\nyour application for Acres was not '\
                      'accepted\
                ,with the following reason \n\n{}'                                                                                                                                                                                    .format(notes)
        ...
        return HttpResponseRedirect("/acres/adm/authentication/client/")

    def notify_user(self, message, email):
        """Send an email message to the provided email."""
        payload = {
            "subject": "Acres Application Status",
            "recipient": [email],
...
class ClientReviewsView(generics.ListCreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        """ allows clients to add reviews to a company """
